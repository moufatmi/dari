    ...
    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 relative">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <button
          ...
          className={`absolute top-3 right-3 p-2 rounded-full transition-colors ${isFavorite
              ...
              : 'bg-white bg-opacity-75 text-gray-500 hover:text-red-500 hover:bg-white'
            }`}
        >
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-2">
          <span className="bg-gray-100 px-2 py-1 rounded text-xs font-medium text-gray-600 uppercase tracking-wider">
        ...
        {/* Title and Price */}
        <div className="mb-3">
          <h3 className="text-lg font-semibold text-gray-900 mb-1 group-hover:text-amber-600 transition-colors line-clamp-1">
            {property.title}
          </h3>
        ...
        {/* Features */}
        <div className="flex items-center justify-between text-sm text-gray-600 mb-4 border-t border-gray-100 pt-3">
